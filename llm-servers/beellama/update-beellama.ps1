...
.DESCRIPTION
    Fetches the newest release (including prereleases) from
    Anbeeld/beellama.cpp, downloads the Windows x64 (CUDA 13) zip,
    extracts it, and overwrites conflicting files in beellama/bin.
